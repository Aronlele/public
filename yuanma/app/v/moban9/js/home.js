...
var MAC={
	...
	'Copy': function(s){
		if (window.clipboardData){ window.clipboardData.setData("Text",s); } 
			...
			$('#mac_flash_copy').html('<embed src='+SitePath+'"images/_clipboard.swf"/*tpa=http://01avz.com/template/m1938/js/images/_clipboard.swf*/ FlashVars="clipboard='+escape(s)+'" width="0" height="0" type="application/x-shockwave-flash"></embed>');
		}
		alert("复制成功");
	},
	'Home': function(o,u){
	...
	'Login':{
		...
		'Create':function($id){
			...
			if(MAC.Cookie.Get('userid')!=undefined && MAC.Cookie.Get('userid')!=''){ 
				html+='<ul class="logged"><li><a target="_blank" href="http://01avz.com/template/m1938/js/'+SitePath+'index.php?m=user-index">我的资料</a></li><li class="logout"><a class="logoutbt" href="javascript:;" onclick="MAC.Login.Out(\''+$id+'\');" target="_self"><i class="ui-icon user-logout"></i>退出</a></li></ul>';
			}
			else{
				html+='<form id="loginform" onsubmit="return false;" action="'+SitePath+'index.php?user-check" method="post"><div class="formitem"><label>用户：</label><input name="username" type="text"  class="input" id="username"/></div><div class="formitem"><label>密码：</label><input name="userpass" type="password" class="input" id="userpass"/></div><div class="formitem"><a class="qq-login" href="http://01avz.com/template/m1938/js/'+SitePath+'index.php?m=user-reg-ref-qqlogin.html"></a> <input class="formbutton" id="loginbtn" type="submit" value="登 录"></div><div class="formitem"><a title="忘记密码" class="forgotpass" href="http://01avz.com/template/m1938/js/'+SitePath+'index.php?m=user-findpass.html">忘记密码?</a>  <a class="reg-btn" href="http://01avz.com/template/m1938/js/'+SitePath+'index.php?m=user-reg.html" target="_blank">还没有账号?</a></div></form>';
			}
	...
	'Score': {
		'ajaxurl': 'http://01avz.com/template/m1938/js/inc/ajax.php?ac=score',
	...
	'Lazyload':{
		'Show': function(){
			$("http://01avz.com/template/m1938/js/img.lazy").lazyload();
			try {  }catch(e){};
		},
		'Box': function($id){
			$("http://01avz.com/template/m1938/js/img.lazy").lazyload({
